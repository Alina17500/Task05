...
/*
 * Есть функция (процедура), которая делает основную работу, но не знает, как сделать какие-то конкретные шаги
 * т.е. данная функция просто обходит дерево, но конкретного ничего с узлами не делает
 * "процедура обратного вызова"
 * посылаем на вход параметр --> делаем данную процедуру --> доходим до места, где не знаем, что сделать -->
 * вызываем процедуру, выполняющую какое-то действие --> опять доходим до места...
 */
