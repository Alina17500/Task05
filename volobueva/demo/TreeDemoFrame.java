package ru.vsu.cs.volobueva.demo;

import com.intellij.uiDesigner.core.GridConstraints;
import com.intellij.uiDesigner.core.GridLayoutManager;
import com.intellij.uiDesigner.core.Spacer;
import ru.vsu.cs.volobueva.BinaryTreeAlgorithms;
import ru.vsu.cs.volobueva.SimpleBinaryTree;
import ru.vsu.cs.volobueva.BinaryTreePainter;
import ru.vsu.cs.volobueva.BinaryTree;
import ru.vsu.cs.volobueva.bst.BSTree;
import ru.vsu.cs.volobueva.bst.SimpleBSTree;
...
public class TreeDemoFrame extends JFrame {
    ...
    private JButton buttonDeleteNonLowerLeaves;
...
//((Integer) spinnerRandomCount.getValue()).intValue();
        ...
        buttonDeleteNonLowerLeaves.addActionListener(actionEvent -> {
            try {
                SimpleBSTree bsTree = new SimpleBSTree();
                bsTree.deleteLeavesNotLowLevel((BSTree<Integer>) tree);
                repaintTree();
            } catch (Exception ex) {
                SwingUtils.showErrorMessageBox(ex);
            }
    ...
    private void showSystemOut(Runnable action) {
        ...
        try {
            System.setOut(new PrintStream(boas, true, "UTF-8"));

            action.run();

            textAreaSystemOut.setText(boas.toString("UTF-8"));
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("Tree in parenthesis notation:");
        ...
        buttonMakeTree.setText("Build three");
        ...
        buttonMakeBSTree.setText("Build search tree");
        ...
        buttonRandomGenerate.setText("Generate");
        ...
        buttonMakeBSTree2.setText("Build search tree");
        ...
        buttonRemoveValue.setText("Remove");
        ...
        buttonDeleteNonLowerLeaves = new JButton();
        buttonDeleteNonLowerLeaves.setText("Delete leaves");
        panel6.add(buttonDeleteNonLowerLeaves, new GridConstraints(0, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        buttonSaveImage.setText("Save in SVG");
        ...
        buttonToBracketNotation.setText("In parenthesis notation");
        ...
        checkBoxTransparent.setText("transparence");
